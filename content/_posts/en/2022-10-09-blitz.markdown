...
## App Recommendation
There is a great Android app that lets you play with different types of cards (German suits, reguar suits):  
[31 App](https://play.google.com/store/apps/details?id=com.donkeycat.hosnobeol&pcampaignid=web_share)
